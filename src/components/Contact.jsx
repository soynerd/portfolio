...
export default function Contact() {
  ...
  return (
    ...
    <div className="flex flex-row md:mt-20 md:py-20 justify-center items-center ">
      <div className="w-1/3 hidden md:flex flex-col justify-center items-center bg-gradient-to-br from-slate-950 to-gray-500 rounded-2xl p-6 shadow-xl">
      ...
      <div className="w-2/3 max-w-md min-w-[350px] bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700">
