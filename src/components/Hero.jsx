            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-1/2">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/600x400/1e293b/ffffff?text=My+Work";
                }}
              />
              ...
              <div className="flex flex-row mt-4  gap-6 items-center">
                ...
                <div className="flex flex-row gap-2 text-3xl">
                  <a
                    href="https://github.com/soynerd"
                    className="text-black hover:text-indigo-700 dark:text-gray-300"
                  >
                    <FaGithub />
                  </a>
                  <a
                    href="https://linkedin.com/in/soynerd"
                    className="text-black hover:text-indigo-700 dark:text-gray-300"
                  >
                    <FaLinkedinIn />
                  </a>
                  <a
                    href="https://instagram.com/soynerd"
                    className="text-black hover:text-indigo-700 dark:text-gray-300"
                  >
                    <FaInstagram />
                  </a>
              ...
              <p className="mt-6 max-w-lg text-lg text-gray-600 dark:text-gray-300">
                Building beautiful, responsive, and intuitive web experiences
                from my base in India. Passionate about clean code and great
                user interfaces.
              </p>
            </div>
            <div className="w-full lg:w-1/2 md:h-[500px] lg:h-[600px] flex flex-col items-center">
              <Spline
                scene="https://prod.spline.design/dvs1w-cITCPdSG-o/scene.splinecode"
              ...
              <div className="mt-4 md:mt-10 flex flex-col sm:flex-row items-center gap-4 mb-25">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://placehold.co/128x128/6366f1/white?text=N";
                  }}
                />
                <a
